...
export default function KanbanBoard() {
  ...
  return (
    <div className="container-fluid py-4 d-flex justify-content-center">
      <div
        className="border border-secondary-subtle rounded-4 bg-white shadow-sm"
        style={{ width: 'calc(100% - 5rem)', maxWidth: '1400px', minWidth: 0 }}
      >
        ...
        <div className="d-flex justify-content-center gap-3 px-3 pb-3" style={{ overflowX: 'auto' }}>
